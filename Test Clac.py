...
txtDisplay = Entry(calc, font=('Arial', 20, 'bold'), bg='grey', fg='black', bd=30, width=28, justify=RIGHT,
                   relief='ridge')
...
for j in range(2, 5):
    for k in range(3):
        btn.append(Button(calc, width=6, height=2,
                          bg='grey', fg='black', font=('Arial', 20, 'bold'),
                          bd=4, text=numberpad[i]))
        btn[i].grid(row=j, column=k, pady=1)
        btn[i]["command"] = lambda x=numberpad[i]: added_value.numberenter(x)
        i += 1

Button(calc, text=chr(67), width=6, height=2,
       bg='grey', font=('Arial', 20, 'bold'),
       bd=4, command=added_value.clear_entry
       ).grid(row=1, column=0, pady=1)

Button(calc, text=chr(67) + chr(69), width=6, height=2,
       bg='grey', font=('Arial', 20, 'bold'),
...
Button(calc, text=chr(177), width=6,
       height=2, bg='grey', font=('Arial', 20, 'bold'),
...
lblDisplay = Label(calc, text="Scientific Calculator",
                   font=('Arial', 30, 'bold'),
                   bg='black', fg='grey', justify=CENTER)
